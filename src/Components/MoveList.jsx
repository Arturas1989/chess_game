...
const King = () => {
  return (
    <g width="100%" height="100%" fill="none" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
...
const Piece = ({width, piece}) => {
  ...
  return (
    <svg
      width='100%'
      height='100%'
      viewBox={`-5 0 ${viewBoxWidth} ${viewBoxHeight}`}
